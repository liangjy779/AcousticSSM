...
class S4Model_SS6(nn.Module):
    ...
    def __init__(
        ...
        self.contlayer2 = nn.Linear(735,256)
...
class S4Model_FT6(nn.Module):
    ...
    def __init__(
        ...
        self.ss = S4Model_SS6(d_input, pt=None, lr=lr, d_output=d_output, d_model=d_model, n_layers=n_layers, dropout=dropout, prenorm=prenorm, dropout_fn=dropout_fn)
        ...
        self.decoder = nn.Linear(256, d_output)
