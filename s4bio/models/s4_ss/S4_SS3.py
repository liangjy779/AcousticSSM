...
class S4Model_SS3(nn.Module):
    ...
    def __init__(
        ...
        self.Pdout = nn.Dropout()
        self.Pf = nn.Conv1d(128,4,1)

        #cont
        self.contl = nn.Linear(735,128)
        self.bilinear_product_weight = nn.Parameter(torch.randn(128,128))
    ...
    def forward(self, x):
        ...
        if self.pt:
            ...
            #x_mfcc = x_mfcc.mean(dim=3)#(16,128,1)
            ...
            x_cont = self.contl(x2)#(16,735)->(16,512)
            #x_cont = x2
            ...
            return x, y_hat,x_mfcc,x_lps,cont_output
...
class S4Model_FT3(nn.Module):
    ...
    def __init__(
        ...
        self.ss = S4Model_SS3(d_input, pt=None, lr=lr, d_output=d_output, d_model=d_model, n_layers=n_layers, dropout=dropout, prenorm=prenorm, dropout_fn=dropout_fn)
