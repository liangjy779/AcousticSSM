...
class S4Model_SS5_BIGS(nn.Module):
...
class S4Model_FT5_BIGS(nn.Module):
    ...
    def __init__(
        ...
        self.ss = S4Model_SS5_BIGS(d_input, pt=None, lr=lr, d_output=d_output, d_model=d_model, n_layers=n_layers, dropout=dropout, prenorm=prenorm, dropout_fn=dropout_fn)
