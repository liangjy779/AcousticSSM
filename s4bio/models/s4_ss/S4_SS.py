...
class S4Model_SS(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.pt:
            #x with shape(16,H,1871)(B,H,L)
            x2 = x.mean(dim=1)#(B,L)(16,1871)
            x = x.unsqueeze(2)#x shape is (B,H,1,L)(16,128,1,1871)
...
class S4Model_FT(nn.Module):
    ...
    def __init__(
        ...
        self.ss = S4Model_SS(d_input,False, lr, d_output, d_model, n_layers, dropout, prenorm, dropout_fn)
