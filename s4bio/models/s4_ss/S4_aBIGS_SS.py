...
class S4Model_aBIGS_SS(nn.Module):
...
class S4Model_aBIGS_FT(nn.Module):
    ...
    def __init__(
        ...
        self.ss = S4Model_aBIGS_SS(d_input, False, d_output, d_model, n_layers, dropout, prenorm, lr, dropout_fn)
