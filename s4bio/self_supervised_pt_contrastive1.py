...
parser.add_argument('--mse_scale', default=1.0, type=float, help='Loss scale')
...
class Trainer:
    ...
    def train(self, epoch):
        ...
        for batch_idx in tqdm(range(self.args.train_steps)):
            ...
            loss = args.mse_scale * mse_loss + args.nce_scale * nce_loss + args.mse_mfcc_scale * mse_mfcc_loss + args.mse_lps_scale * mse_lps_loss + args.cont_scale * cont_loss
            loss.backward()
            self.optimizer.step()
            ...
            print('mse_loss: %d  cont_loss: %d  mse_mfcc_loss: %d  mse_lps_loss: %d' %
                  (mse_loss,cont_loss,mse_mfcc_loss,mse_lps_loss)
                 )
